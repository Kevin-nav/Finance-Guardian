...
object DatabaseMigrations {
    ...
    val MIGRATION_3_4: Migration = object : Migration(3, 4) {
        override fun migrate(db: SupportSQLiteDatabase) {
            ...
            db.execSQL("ALTER TABLE transactions ADD COLUMN eventChannel TEXT")
            db.execSQL("ALTER TABLE transactions ADD COLUMN eventSourceInstrumentType TEXT")
            db.execSQL("ALTER TABLE transactions ADD COLUMN eventSourceInstrumentProvider TEXT")
            db.execSQL("ALTER TABLE transactions ADD COLUMN eventSourceInstrumentIdentifier TEXT")
            db.execSQL("ALTER TABLE transactions ADD COLUMN eventDestinationInstrumentType TEXT")
            db.execSQL("ALTER TABLE transactions ADD COLUMN eventDestinationInstrumentProvider TEXT")
            db.execSQL("ALTER TABLE transactions ADD COLUMN eventDestinationInstrumentIdentifier TEXT")
            db.execSQL("ALTER TABLE transactions ADD COLUMN eventProviderReference TEXT")
            db.execSQL("ALTER TABLE transactions ADD COLUMN eventInferredIdentifiers TEXT")
